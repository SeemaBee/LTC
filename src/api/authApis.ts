...
export const loginApi = async (email: string, password: string) => {
  ...
  try {
    const response = await apiClient.post(CommonRoutes.login, {
      email,
      password,
    });
...
export const registerUser = async (data: object) => {
  ...
  try {
    const response = await apiClient.post(CommonRoutes.signup, data);
    return response.data;
  } catch (error: any) {
...
export const forgotApi = async (data: { email: string }) => {
  ...
  try {
    const response = await apiClient.post(CommonRoutes.forgot, data);
    return response.data;
  } catch (error: any) {
    throw new Error(error?.response?.data?.message ?? 'Something went wrong');
  }
...
export const verifyOtp = async (data: { email: string; otp: string }) => {
  ...
  try {
    const response = await apiClient.post(CommonRoutes.verifyOtp, data);
    return response.data;
  } catch (error: any) {
    throw new Error(error?.response?.data?.message ?? 'Something went wrong');
  }
...
export const resendOtp = async (data: { email: string }) => {
  ...
  try {
    const response = await apiClient.post(CommonRoutes.resendOtp, data);
    return response.data;
  } catch (error: any) {
    throw new Error(error?.response?.data?.message ?? 'Something went wrong');
  }
...
export const resetPasswordApi = async (data: {
  ...
  try {
    const response = await apiClient.post(CommonRoutes.resetPassword, data);
    return response.data;
  } catch (error: any) {
    throw new Error(error?.response?.data?.message ?? 'Something went wrong');
  }
...
export const logoutApi = async () => {
  ...
  try {
    const response = await apiClient.post(CommonRoutes.logout);
    return response.data;
  } catch (error: any) {
    throw new Error(error?.response?.data?.message ?? 'Something went wrong');
  }
